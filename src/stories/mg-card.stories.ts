...
export const Animals = () => html`
    <div>
        ${VALUES_ARRAY.map((value) => html`<mg-card phase="flipped" visual="animals" value="${value}" />`)}
    </div>
`

export const Characters = () => html`
    <div>
        ${VALUES_ARRAY.map((value) => html`<mg-card phase="flipped" visual="characters" value="${value}" />`)}
    </div>
`

export const Transport = () => html`
    <div>
        ${VALUES_ARRAY.map((value) => html`<mg-card phase="flipped" visual="transport" value="${value}" />`)}
    </div>
`
